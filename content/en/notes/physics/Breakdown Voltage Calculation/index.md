...
To quantify the *impact ionization* process, we can analyze variance of the current density flow from the end of the depletion region to the another. We can define *M* the multiplication factor to describe the change of the current density.
